...
export default function OptionChainTab({ settings, setSettings }: OptionChainTabProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-6 rounded-2xl border border-[#8c52ff]/20 space-y-5 h-[420px] flex flex-col justify-between shadow-xl hover:shadow-purple-500/5 transition-all duration-300">
        <div>
          <div className="flex items-center gap-3 border-b border-border pb-3">
      ...
      <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-6 rounded-2xl border border-[#00f2fe]/20 space-y-5 h-[420px] flex flex-col justify-between shadow-xl hover:shadow-cyan-500/5 transition-all duration-300">
        <div>
          <div className="flex items-center gap-3 border-b border-border pb-3">
